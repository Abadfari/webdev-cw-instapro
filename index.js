...
// Я делал коммиты не создавая других веток, только сейчас понял что нельзя сделать пул-реквест если все коммиты из одной ветки, поэтому пишу это. Прошу прощения за неудобства
